...
const CreateAnnouncement = ({ navigation }: any) => {
  ...
  const [whoOptions, setWhoOptions] = useState(['Entire Department', 'Specific Role'])
  ...
  const SelectDepartment = (item : any) => {
    if (item === 'Entire Department') {
        setData({
        ... data,
            ...
            <Modal visible={visible} onDismiss={hideRoleModal} contentContainerStyle={containerStyle}>
                ...
                {roles.length > 0 ? (
                    <View>
                        ...
                        return (
                            <TouchableOpacity onPress={() => SelectRole(title)}>
                ...
                <View style={{ alignItems: 'center'}}>
                    <ScrollView style={{height: '70%'}} showsVerticalScrollIndicator={false}>
                        ...
                        <View style={{flexDirection: 'row', alignItems: 'center',}}>
                                <View style={{borderRadius: 20, paddingHorizontal: 0, paddingVertical: 0}}>
